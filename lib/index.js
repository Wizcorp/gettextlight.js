...
var SPLIT_LINES_RE = /\s*\n\s*/g;
var HEADERS_RE = /^([^:]+):((?:[ \t]+[^\n]+\n)+)/;
var PLURAL_FORM_VALIDATION_RE = /^(\s+|[0-9]+|n|[*+\-%<>?:()]|[<>!=]=|\|\||&&)+$/;
var OPENING_PAREN_RE = /\(/g;
var CLOSING_PAREN_RE = /\)/g;
...
exports.gettext = function (msgid) {
	return exports.dpngettext(null, null, msgid, null, 1);
};
 ...
 */
exports.ngettext = function (msgid, msgid_plural, n) {
	return exports.dpngettext(null, null, msgid, msgid_plural, n);
};
 ...
 * @return {String}              String found in the catalog, or msgid if not found.
 */
exports.dgettext = function (domain_name, msgid) {
	return exports.dpngettext(domain_name, null, msgid, null, 1);
};
 ...
 * @return {String}               Pluralization as found in the catalog, or msgid if n === 1, or msgid_plural otherwise.
 */
exports.dngettext = function (domain_name, msgid, msgid_plural, n) {
	return exports.dpngettext(domain_name, null, msgid, msgid_plural, n);
};
 ...
 * @return {String}        String found in the catalog, or msgid if not found.
 */
exports.pgettext = function (msgctxt, msgid) {
	return exports.dpngettext(null, msgctxt, msgid, null, 1);
};
 ...
 * @return {String}             Pluralization as found in the catalog, or msgid if n === 1, or msgid_plural otherwise.
 */
exports.pngettext = function (msgctxt, msgid, msgid_plural, n) {
	return exports.dpngettext(null, msgctxt, msgid, msgid_plural, n);
};
 ...
 * @return {String}              String found in the catalog, or msgid if not found.
 */
exports.dpgettext = function (domain_name, msgctxt, msgid) {
	return exports.dpngettext(domain_name, msgctxt, msgid, null, 1);
};
 ...
 * @return {String}                Pluralization as found in the catalog, or msgid if n === 1, or msgid_plural otherwise.
 */
exports.dpngettext = function (domain_name, msgctxt, msgid, msgid_plural, n) {
 ...
 * @internal
 */
exports.parse = function (domain_name, source, listener) {
	...
	var checkPluralForm = function checkPluralForm(form) {
		var opening_count = (form.match(OPENING_PAREN_RE) || []).length;
		var closing_count = (form.match(CLOSING_PAREN_RE) || []).length;
 ...
 */
exports.load = function load(source, onerror) {
	return exports.loadDomain(null, source, onerror);
};
...
exports.release = function release() {
	return exports.releaseDomain(null);
};
 ...
 *                                         - {Boolean} fatal       Whether the error caused the parsing to stop or not.
 */
exports.loadDomain = function loadDomain(domain_name, source, onerror) {
	domain_name = domain_name || DEFAULT_DOMAIN;

	exports.releaseDomain(domain_name);
	var entries = {},
		pluralForms = default_plural,
		failed = false;

	exports.parse(domain_name, source, function (type, data) {
		switch (type) {
		case 'error':
 ...
 * @param {?String=} domain_name Domain identifier. Defaults to 'messages' if null or not provided.
 */
exports.releaseDomain = function releaseDomain(domain_name) {
	domain_name = domain_name || DEFAULT_DOMAIN;
	domains[domain_name] = {};
};
...
/**
 * @param domain_name
 * @desc Set a default domain
 */
exports.textdomain = function textdomain(domain_name) {
